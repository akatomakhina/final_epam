...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    public Order createOrder(List<ProductItem> itemList, int idUser, boolean isFromBalance) throws ServiceException {
        ...
        try {
            ...
            if (isFromBalance){
                ...
                int balanceAfterTransaction = userDAO.getUserBalance(idUser) - totalAmount;
                userDAO.updateBalance(balanceAfterTransaction, idUser);
            }
    ...
    @Override
    public List<ProductItem> getItemsByOrder(Order order) throws ServiceException {
